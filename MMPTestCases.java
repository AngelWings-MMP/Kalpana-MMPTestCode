...
public class MMPTestCases { 
	...
	@AfterTest(enabled=false, description = "TC91: User logged out of the Account")
	...
	@Test(enabled=false,priority = 2,description="TC90: Blank Login")
	...
	@Parameters({"Age"})
	@Test(enabled=false,priority = 3,description = "Editing information in User Profile",dependsOnMethods = {"Login"})
	...
	@Test(enabled=false, priority=3, description="TC97: EditProfilePage_blank",dependsOnMethods = {"Login"})
	...
	@Test(enabled=false, priority=3, description="TC96: EditProfilePage_invalid",dependsOnMethods = {"Login"})
	...
	@Test(enabled=false,priority = 4,description = "TC98: User Scheduling an Appointment",dependsOnMethods = {"Login"})
	...
	@Test(enabled=false,priority=5, description = "TC80: Doctor's Information",dependsOnMethods = {"Login"})
	...
	@Test(enabled=false, priority=6, description="TC84: User is able to send Messages to Doctor",dependsOnMethods = {"Login"})
	...
	@Test(enabled=false, priority=7, description = "TC81: User's Fees information", dependsOnMethods = {"Login"})
	...
	@Test(enabled=false, priority=8, description="TC82: User is able to view the Reports", dependsOnMethods = {"Login"})
	...
	@Parameters({"symptoms"})
	@Test(enabled=false, priority=9, description="Search for Symptoms", dependsOnMethods = {"Login"})
	...
	@Test(enabled=false, priority=10, description="View Past Transaction",dependsOnMethods = {"Login"})
	...
	@Test(enabled=false, priority=11, description = "View Past Appointments",dependsOnMethods = {"Login"})
	...
	@Test(enabled=false, priority=12, description = "View Past Diagnosis",dependsOnMethods = {"Login"})
	...
	@Test(enabled=false, priority=13, description="View Past Prescription",dependsOnMethods = {"Login"})
